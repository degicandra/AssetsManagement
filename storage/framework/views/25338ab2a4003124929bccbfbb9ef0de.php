...
<?php $__env->startSection('header', 'Edit Asset'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-4xl mx-auto">
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
        <form action="<?php echo e(route('assets.update', $asset)); ?>" method="POST" enctype="multipart/form-data" class="space-y-8">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>
            <div class="mb-4">
                <h2 class="text-2xl font-semibold text-gray-900 dark:text-gray-200">Edit Asset</h2>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Update asset details and optional specifications.</p>
            </div>
                ...
                <div>
                    <label for="company" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        Company *
                          ...
                          <input type="text" name="company" id="company" value="<?php echo e(old('company', $asset->company)); ?>" required
                ...
                <div>
                    <label for="asset_code" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        Asset Code *
                          ...
                          <input type="text" name="asset_code" id="asset_code" value="<?php echo e(old('asset_code', $asset->asset_code)); ?>" required
                              class="w-full rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 shadow-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500">
                ...
                <div>
                    <label for="serial_number" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        Serial Number
                          ...
                          <input type="text" name="serial_number" id="serial_number" value="<?php echo e(old('serial_number', $asset->serial_number)); ?>"
                              class="w-full rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 shadow-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500">
                </div>
                ...
                <div>
                    <label for="model" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        Model *
                          ...
                          <input type="text" name="model" id="model" value="<?php echo e(old('model', $asset->model)); ?>" required
                              class="w-full rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 shadow-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500">
                ...
                <div>
                    <label for="brand" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        Brand *
                          ...
                          <input type="text" name="brand" id="brand" value="<?php echo e(old('brand', $asset->brand)); ?>" required
                              class="w-full rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 shadow-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    <label for="status" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        ...
                        <option value="archive" <?php echo e(old('status', $asset->status) == 'archive' ? 'selected' : ''); ?>>Archive</option>
                        <option value="broken" <?php echo e(old('status', $asset->status) == 'broken' ? 'selected' : ''); ?>>Broken</option>
                        <option value="service" <?php echo e(old('status', $asset->status) == 'service' ? 'selected' : ''); ?>>Service</option>
                        <option value="request_disposal" <?php echo e(old('status', $asset->status) == 'request_disposal' ? 'selected' : ''); ?>>Request Disposal</option>
                        <option value="disposed" <?php echo e(old('status', $asset->status) == 'disposed' ? 'selected' : ''); ?>>Disposed</option>
                    </select>
                    ...
                    <label for="location_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        ...
                        <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($location->id); ?>" 
                                    ...
                                    <?php echo e(old('location_id', $asset->location_id) == $location->id ? 'selected' : ''); ?>>
                ...
                <div>
                    <label for="person_in_charge" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        Person In Charge *
                          ...
                          <input type="text" name="person_in_charge" id="person_in_charge" value="<?php echo e(old('person_in_charge', $asset->person_in_charge)); ?>" required
                              class="w-full rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 shadow-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500">
                ...
                <div>
                    <label for="purchase_date" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        Purchase Date *
                          ...
                          <input type="date" name="purchase_date" id="purchase_date" value="<?php echo e(old('purchase_date', $asset->purchase_date->format('Y-m-d'))); ?>" required
                              class="w-full rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 shadow-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500">
                ...
                <div>
                    <label for="warranty_expiration" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        Warranty Expiration
                          ...
                          <input type="date" name="warranty_expiration" id="warranty_expiration" 
                              value="<?php echo e(old('warranty_expiration', $asset->warranty_expiration ? $asset->warranty_expiration->format('Y-m-d') : '')); ?>"
                              class="w-full rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 shadow-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500">
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="processor" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                           ...
                           <input type="text" name="processor" id="processor" value="<?php echo e(old('processor', $asset->processor)); ?>"
                               class="w-full rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 shadow-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500"
                    ...
                    <div>
                        <label for="storage_size" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                           ...
                           <input type="text" name="storage_size" id="storage_size" value="<?php echo e(old('storage_size', $asset->storage_size)); ?>"
                               class="w-full rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 shadow-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500"
                    ...
                    <div>
                        <label for="ram" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                           ...
                           <input type="text" name="ram" id="ram" value="<?php echo e(old('ram', $asset->ram)); ?>"
                               class="w-full rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 shadow-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500"
                ...
                <?php if($asset->image_path): ?>
                    <div class="mb-4">
                        <img src="<?php echo e(asset('storage/' . $asset->image_path)); ?>" 
                             ...
                             class="max-w-xs h-auto rounded-lg shadow mb-2">
                        <p class="text-sm text-gray-600 dark:text-gray-400">Current image. Upload a new one to replace it.</p>
                    </div>
                <?php endif; ?>
