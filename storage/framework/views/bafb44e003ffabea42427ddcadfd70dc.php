                ...
                <div>
                    ...
                    <select name="floor_id" id="floor_select" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent">
                        ...
                        <?php $__currentLoopData = $floors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $floor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($floor->id); ?>" <?php echo e(old('floor_id') == $floor->id ? 'selected' : ''); ?>><?php echo e($floor->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="date" name="request_date" required class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent" value="<?php echo e(old('request_date', now()->format('Y-m-d'))); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select name="status" required class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent">
                        ...
                        <option value="request_created" <?php echo e(old('status') == 'request_created' ? 'selected' : ''); ?>>Request Created</option>
                        <option value="finance_approval" <?php echo e(old('status') == 'finance_approval' ? 'selected' : ''); ?>>Finance Approval</option>
                        <option value="director_approval" <?php echo e(old('status') == 'director_approval' ? 'selected' : ''); ?>>Director Approval</option>
                        <option value="submitted_purchasing" <?php echo e(old('status') == 'submitted_purchasing' ? 'selected' : ''); ?>>Submitted to Purchasing</option>
                        <option value="item_purchased" <?php echo e(old('status') == 'item_purchased' ? 'selected' : ''); ?>>Item Purchased</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <textarea name="notes" rows="2" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent" placeholder="Add any additional notes..."><?php echo e(old('notes')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex gap-2 pt-4 border-t border-gray-200 dark:border-gray-700">
                ...
                <a href="<?php echo e(route('asset-requests.index')); ?>" class="px-6 py-2 bg-gray-200 dark:bg-gray-600 text-gray-900 dark:text-gray-200 rounded-lg font-medium hover:bg-gray-300 dark:hover:bg-gray-700 transition">
                    Cancel
                </a>
            </div>
        </form>
...
<?php echo $__env->make('layouts.authenticated', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\AssetsManagement\resources\views/asset-requests/create.blade.php ENDPATH**/ ?>