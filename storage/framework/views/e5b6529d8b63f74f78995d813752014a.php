        ...
        <div class="w-64 sidebar-fixed fixed left-0 top-0 h-screen z-40 border-r flex flex-col" style="background-color: var(--bg-color, #ffffff); border-color: var(--border-color, #e5e7eb);">
            ...
            <nav class="flex-1 overflow-y-auto px-2 py-4 space-y-1">
                <a href="<?php echo e(route('dashboard')); ?>" 
                   class="flex items-center px-4 py-2 text-sm font-medium rounded-md <?php echo e(request()->routeIs('dashboard') ? 'bg-green-100 dark:bg-green-900/30 text-green-900 dark:text-green-100' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>" style="color: var(--text-primary-color, #1a1a1a);">
                ...
                <a href="<?php echo e(route('assets.index')); ?>" 
                   class="flex items-center px-4 py-2 text-sm font-medium rounded-md <?php echo e(request()->routeIs('assets.*') ? 'bg-green-100 dark:bg-green-900/30 text-green-900 dark:text-green-100' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>" style="color: var(--text-primary-color, #1a1a1a);">
                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('emails.index')); ?>" 
                   class="flex items-center px-4 py-2 text-sm font-medium rounded-md <?php echo e(request()->routeIs('emails.*') ? 'bg-green-100 dark:bg-green-900/30 text-green-900 dark:text-green-100' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>" style="color: var(--text-primary-color, #1a1a1a);">
                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('licenses.index')); ?>" 
                   class="flex items-center px-4 py-2 text-sm font-medium rounded-md <?php echo e(request()->routeIs('licenses.*') ? 'bg-green-100 dark:bg-green-900/30 text-green-900 dark:text-green-100' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>" style="color: var(--text-primary-color, #1a1a1a);">
                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <div id="settings-menu" class="overflow-hidden transition-all duration-300 ease-in-out max-h-0">
                        <a href="<?php echo e(route('users.index')); ?>" class="flex items-center w-full px-8 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 transition" style="color: var(--text-primary-color, #1a1a1a);">
                        ...
                        <a href="<?php echo e(route('departments.index')); ?>" class="flex items-center w-full px-8 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 transition" style="color: var(--text-primary-color, #1a1a1a);">
                            <svg class="mr-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="<?php echo e(route('floors.index')); ?>" class="flex items-center w-full px-8 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 transition" style="color: var(--text-primary-color, #1a1a1a);">
                            <svg class="mr-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21H5a2 2 0 01-2-2V5a2 2 0 012-2h11l5 5v11a2 2 0 01-2 2z"></path>
                            </svg>
                            Manage Floor
                        </a>
                        <a href="<?php echo e(route('locations.index')); ?>" class="flex items-center w-full px-8 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 transition" style="color: var(--text-primary-color, #1a1a1a);">
                            <svg class="mr-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="<?php echo e(route('types.index')); ?>" class="flex items-center w-full px-8 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 transition" style="color: var(--text-primary-color, #1a1a1a);">
                            <svg class="mr-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <div class="h-8 w-8 rounded-full bg-green-100 dark:bg-green-900/30 flex items-center justify-center">
                            <span class="text-sm font-medium text-green-800 dark:text-green-100" style="color: var(--text-primary-color, #1a1a1a);"><?php echo e(substr(Auth::user()->name, 0, 1)); ?></span>
                        </div>
                    </div>
                    <div class="ml-3">
                        <p class="text-sm font-medium text-gray-700 dark:text-gray-200" style="color: var(--text-primary-color, #1a1a1a);"><?php echo e(Auth::user()->name); ?></p>
                        <p class="text-xs text-gray-500 dark:text-gray-200" style="color: var(--text-secondary-color, #4b5563);"><?php echo e(Auth::user()->email); ?></p>
                    </div>
                </div>
            ...
            <header style="background-color: var(--header-bg-color, #ffffff); border-color: var(--border-color, #e5e7eb);" class="border-b">
                <div class="px-6 py-4">
                    <div class="flex items-center justify-between">
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-200" style="color: var(--text-primary-color, #1a1a1a);"><?php echo $__env->yieldContent('header', 'Dashboard'); ?></h1>
...
</html><?php /**PATH C:\xampp\htdocs\AssetsManagement\resources\views/layouts/authenticated.blade.php ENDPATH**/ ?>