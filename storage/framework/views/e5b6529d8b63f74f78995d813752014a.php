    ...
    <div class="flex h-screen bg-white dark:bg-gray-900">
        ...
        <aside id="sidebar" class="sidebar-fixed sidebar-transition bg-white dark:bg-gray-800 shadow-lg border-r border-gray-200 dark:border-gray-700 flex flex-col">
            ...
            <div class="px-6 py-6 border-b border-gray-200 dark:border-gray-700">
                <h1 class="text-2xl font-bold text-green-600"><?php echo e(config('app.name', 'Assets')); ?></h1>
            </div>

            <!-- Navigation -->
            <nav class="flex-1 px-4 py-6 space-y-3 overflow-y-auto">
                <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center px-4 py-2 text-sm font-medium rounded-md <?php echo e(request()->routeIs('dashboard') ? 'bg-green-100 dark:bg-green-900/30 text-green-900 dark:text-green-500' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>">
                ...
                <a href="<?php echo e(route('assets.index')); ?>" class="flex items-center px-4 py-2 text-sm font-medium rounded-md <?php echo e(request()->routeIs('assets.*') ? 'bg-green-100 dark:bg-green-900/30 text-green-900 dark:text-green-500' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('emails.index')); ?>" class="flex items-center px-4 py-2 text-sm font-medium rounded-md <?php echo e(request()->routeIs('emails.*') ? 'bg-green-100 dark:bg-green-900/30 text-green-900 dark:text-green-500' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('licenses.index')); ?>" class="flex items-center px-4 py-2 text-sm font-medium rounded-md <?php echo e(request()->routeIs('licenses.*') ? 'bg-green-100 dark:bg-green-900/30 text-green-900 dark:text-green-500' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('asset-requests.index')); ?>" class="flex items-center px-4 py-2 text-sm font-medium rounded-md <?php echo e(request()->routeIs('asset-requests.*') ? 'bg-green-100 dark:bg-green-900/30 text-green-900 dark:text-green-500' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="pt-4 mt-4 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <div id="settings-submenu" class="hidden ml-8 mt-2 space-y-2">
                        <a href="<?php echo e(route('users.index')); ?>" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md">Users</a>
                        <a href="<?php echo e(route('departments.index')); ?>" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md">Departments</a>
                        <a href="<?php echo e(route('floors.index')); ?>" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md">Floors</a>
                        <a href="<?php echo e(route('locations.index')); ?>" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md">Locations</a>
                        <a href="<?php echo e(route('types.index')); ?>" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md">Asset Types</a>
                    </div>
                </div>
            </nav>
            ...
            <div class="px-6 py-6 border-t border-gray-200 dark:border-gray-700 space-y-4">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="w-10 h-10 rounded-full bg-green-300 dark:bg-green-900/30 text-green-900 dark:text-green-500 flex items-center justify-center flex-shrink-0">
                        <span class="text-green-900 dark:text-green-600 font-bold text-sm"><?php echo e(strtoupper(substr(Auth::user()->name, 0, 1))); ?></span>
                    </div>
        ...
        <main class="flex-1 overflow-auto bg-gray-50 dark:bg-gray-900">
            ...
            <div class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-4 flex items-center justify-between">
                ...
                <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100"><?php echo $__env->yieldContent('header', 'Dashboard'); ?></h1>
...
<?php /**PATH C:\xampp\htdocs\AssetsManagement\resources\views/layouts/authenticated.blade.php ENDPATH**/ ?>