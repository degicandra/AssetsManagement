...
<div class="max-w-2xl mx-auto">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border border-gray-200 dark:border-gray-700">
        <form action="<?php echo e(route('emails.update', $email)); ?>" method="POST" class="space-y-6">
            ...
            <div class="mb-4">
                <h2 class="text-2xl font-semibold text-gray-900 dark:text-gray-200">Edit Email</h2>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Update email details.</p>
            </div>
