...
<?php $__env->startSection('header', 'Asset Details'); ?>
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                        <?php echo e($asset->model); ?> - <?php echo e($asset->brand); ?>
                            ...
                            <dd class="mt-1">
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                    <?php switch($asset->status):
                                        ...
                                        <?php case ('disposed'): ?> bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-200 <?php break; ?>
                                    <?php endswitch; ?>">
                ...
                <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900 dark:text-white"><?php echo e($asset->ram); ?></dd>
                        </div>
                        <?php endif; ?>
                        <?php if($asset->specification_upgraded): ?>
                        <div>
                            <dt class="text-sm font-medium text-gray-700 dark:text-gray-100">Specification Upgraded</dt>
                            <dd class="mt-1 text-sm text-gray-900 dark:text-white"><?php echo e($asset->specification_upgraded); ?></dd>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
...
<div id="upgradeModal" class="hidden fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4 transition-opacity duration-300">
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md transform transition-all duration-300 scale-100 opacity-100">
        ...
        <!-- Modal Body -->
        <form action="<?php echo e(route('assets.upgrade', $asset)); ?>" method="POST" class="p-6 space-y-5">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <?php $__errorArgs = ['component_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    <p class="mt-1 text-sm text-red-500 font-medium"><?php echo e($message); ?></p>
                <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <?php $__errorArgs = ['new_specification'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
