...
<?php $__env->startSection('header', 'License Details'); ?>
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">
                        <?php echo e($license->software_name); ?>

                    </h1>
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                        <?php echo e(ucfirst(str_replace('_', ' ', $license->status))); ?> • License Key: <?php echo e($license->license_key); ?>

                    </p>
                </div>
                <div class="flex flex-wrap gap-2">
                    <a href="<?php echo e(route('licenses.edit', $license)); ?>" 
                    ...
                    <form action="<?php echo e(route('licenses.destroy', $license)); ?>" method="POST" class="inline">
                        <?php echo csrf_field(); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-6">
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">License Information</h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <dt class="text-sm font-medium text-gray-700 dark:text-gray-100">Software Name</dt>
                            <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100"><?php echo e($license->software_name); ?></dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-700 dark:text-gray-100">License Key</dt>
                            <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100 font-mono"><?php echo e($license->license_key); ?></dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-700 dark:text-gray-100">Purchase Date</dt>
                            <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100"><?php echo e($license->purchase_date->format('M d, Y')); ?></dd>
                        </div>
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100">
                                ...
                                <?php if($license->days_until_expiry !== null): ?>
                                    <span class="text-xs <?php echo e($license->days_until_expiry < 30 ? 'text-red-600' : 'text-gray-500'); ?>">
                                        (<?php echo e($license->days_until_expiry); ?> days remaining)
                                    </span>
                                <?php endif; ?>
                            </dd>
                        </div>
                        <div>
                            ...
                            <dd class="mt-1">
                                <span class="px-3 py-1 rounded-full text-xs font-semibold <?php echo e($license->status_badge_class); ?>">
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100"><?php echo e($license->department->name ?? 'N/A'); ?></dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-700 dark:text-gray-100">Quantity</dt>
                            <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100"><?php echo e($license->quantity ?? '-'); ?></dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-700 dark:text-gray-100">Created</dt>
                            <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100"><?php echo e($license->created_at->format('M d, Y H:i')); ?></dd>
                        </div>
                    </div>
                </div>
            ...
            <div class="lg:col-span-1">
                <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-6">
                    ...
                    <div class="space-y-4">
                        <?php $__empty_1 = true; $__currentLoopData = $license->licenseHistories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="border-l-4 border-green-500 pl-4 py-2">
                                ...
                                <div class="text-xs text-gray-400 dark:text-gray-400 mt-1">
                                    <?php echo e($history->created_at->format('M d, Y H:i')); ?> by <?php echo e($history->user->name ?? 'System'); ?>
...
<?php echo $__env->make('layouts.authenticated', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\AssetsManagement\resources\views/licenses/show.blade.php ENDPATH**/ ?>