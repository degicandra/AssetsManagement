                ...
                <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900 dark:text-white"><?php echo e($license->software_name); ?></dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-700 dark:text-gray-100">License Key</dt>
                            <dd class="mt-1 text-sm text-gray-900 dark:text-white font-mono"><?php echo e($license->license_key); ?></dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-700 dark:text-gray-100">Purchase Date</dt>
                            <dd class="mt-1 text-sm text-gray-900 dark:text-white"><?php echo e($license->purchase_date->format('M d, Y')); ?></dd>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900 dark:text-white"><?php echo e($license->department->name ?? 'N/A'); ?></dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-700 dark:text-gray-100">Quantity</dt>
                            <dd class="mt-1 text-sm text-gray-900 dark:text-white"><?php echo e($license->quantity ?? '-'); ?></dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-700 dark:text-gray-100">Created</dt>
                            <dd class="mt-1 text-sm text-gray-900 dark:text-white"><?php echo e($license->created_at->format('M d, Y H:i')); ?></dd>
                        </div>
                    </div>
                </div>
