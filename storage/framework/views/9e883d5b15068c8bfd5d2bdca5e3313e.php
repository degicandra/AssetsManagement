...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            <h2 class="text-2xl font-bold text-gray-900 dark:text-gray-200">Department Management</h2>
            ...
            <table class="w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700" id="department-table-body">
                    <?php $__empty_1 = true; $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="department-row hover:bg-gray-50 dark:hover:bg-gray-700 transition" data-name="<?php echo e(strtolower($dept->name)); ?>">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900 dark:text-gray-200"><?php echo e($dept->name); ?></div>
                            </td>
                            <td class="px-6 py-4 max-w-md">
                                <div class="text-sm text-gray-600 dark:text-gray-400"><?php echo e($dept->description ?? '-'); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-600 dark:text-gray-400"><?php echo e($dept->created_at->format('M d, Y')); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm space-x-2">
                                <button onclick='openEditDepartmentModal(<?php echo json_encode($dept); ?>)' class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300 font-medium">Edit</button>
                                <form action="<?php echo e(route('departments.destroy', $dept)); ?>" method="POST" class="inline">
                                    <?php echo csrf_field(); ?>
    ...
    <div class="modal-content">
        ...
        <form id="department-form" method="POST" class="space-y-4">
            ...
            <div class="flex gap-2 mt-6">
                ...
                <button type="button" onclick="closeDepartmentModal()" class="px-4 py-2 bg-gray-300 dark:bg-gray-600 text-gray-900 dark:text-gray-200 rounded-md">Cancel</button>
            </div>
        </form>
    </div>
</div>
...
<script>
    ...
    function openDepartmentModal() {
        ...
        document.getElementById('department-form').action = `<?php echo e(route('departments.store')); ?>`;
...
<?php echo $__env->make('layouts.authenticated', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\AssetsManagement\resources\views/departments/index.blade.php ENDPATH**/ ?>