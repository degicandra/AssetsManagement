...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            <h2 class="text-2xl font-bold text-gray-900 dark:text-gray-200">Email Management</h2>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        async function fetchFilteredEmails(page = 1) {
            ...
            try {
                ...
                const response = await fetch(`{{ route('emails.json-filter') }}?${params}`, {
                    method: 'GET',
                    headers: {
    ...
    function openEmailModal() {
        ...
        content.innerHTML = `
            <div class="p-6">
                ...
                <form action="{{ route('emails.store') }}" method="POST" class="space-y-4">
                    ...
                    <div class="flex gap-2 mt-6">
                        ...
                        <button type="button" onclick="closeEmailModal()" class="px-4 py-2 bg-gray-300 dark:bg-gray-600 text-gray-900 dark:text-gray-200 rounded-md">Cancel</button>
                    </div>
                </form>
            </div>
        `;
