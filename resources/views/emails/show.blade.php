                        ...
                        <div>
                            ...
                            <dd class="mt-1">
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                    @switch($email->status)
                                        @case('active') bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-200 @break
                                        @case('inactive') bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-200 @break
                                        @case('not used') bg-gray-100 text-gray-800 dark:bg-gray-900/30 dark:text-gray-200 @break
                                    @endswitch">
                                    {{ $email->status == 'not used' ? 'Not Used' : ucfirst($email->status) }}
                                </span>
                            </dd>
                        </div>
