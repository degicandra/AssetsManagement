...
<div class="space-y-6 min-h-screen" style="background-color: var(--content-bg-color, #ffffff);">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
        <a href="{{ route('assets.index') }}" class="rounded-lg shadow p-4 border hover:shadow-lg transition-shadow cursor-pointer" style="background-color: var(--card-bg-color, #ffffff); border-color: var(--border-color, #e5e7eb);">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xl font-bold" style="color: var(--text-primary-color, #00a400);">{{ $totalAssets }}</p>
                </div>
            </div>
        </a>

        <a href="{{ route('assets.index', ['status' => 'deployed']) }}" class="rounded-lg shadow p-4 border hover:shadow-lg transition-shadow cursor-pointer" style="background-color: var(--card-bg-color, #ffffff); border-color: var(--border-color, #e5e7eb);">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xl font-bold" style="color: var(--blue-text-color, #2563eb);">{{ $deployed }}</p>
                </div>
            </div>
        </a>

        <a href="{{ route('assets.index', ['status' => 'ready_to_deploy']) }}" class="rounded-lg shadow p-4 border hover:shadow-lg transition-shadow cursor-pointer" style="background-color: var(--card-bg-color, #ffffff); border-color: var(--border-color, #e5e7eb);">
            <div class="flex items-center">
                <div class="p-2 rounded-full" style="background-color: var(--blue-bg-color, #dbeafe);">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: var(--blue-text-color, #2563eb);">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xl font-bold" style="color: var(--text-primary-color, #111827);">{{ $readyToDeploy }}</p>
                </div>
            </div>
        </a>

        <a href="{{ route('assets.index', ['status' => 'archive']) }}" class="rounded-lg shadow p-4 border hover:shadow-lg transition-shadow cursor-pointer" style="background-color: var(--card-bg-color, #ffffff); border-color: var(--border-color, #e5e7eb);">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xl font-bold" style="color: var(--text-primary-color, #111827);">{{ $archive }}</p>
                </div>
            </div>
        </a>

        <a href="{{ route('assets.index', ['status' => 'broken']) }}" class="rounded-lg shadow p-4 border hover:shadow-lg transition-shadow cursor-pointer" style="background-color: var(--card-bg-color, #ffffff); border-color: var(--border-color, #e5e7eb);">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xl font-bold" style="color: var(--text-primary-color, #111827);">{{ $broken }}</p>
                </div>
            </div>
        </a>

        <a href="{{ route('assets.index', ['status' => 'in_service']) }}" class="rounded-lg shadow p-4 border hover:shadow-lg transition-shadow cursor-pointer" style="background-color: var(--card-bg-color, #ffffff); border-color: var(--border-color, #e5e7eb);">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xl font-bold" style="color: var(--text-primary-color, #111827);">{{ $inService }}</p>
                </div>
            </div>
        </a>

        <a href="{{ route('assets.index', ['status' => 'request_disposal']) }}" class="rounded-lg shadow p-4 border hover:shadow-lg transition-shadow cursor-pointer" style="background-color: var(--card-bg-color, #ffffff); border-color: var(--border-color, #e5e7eb);">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xl font-bold" style="color: var(--text-primary-color, #111827);">{{ $requestDisposal }}</p>
                </div>
            </div>
        </a>
        ...
        <a href="{{ route('licenses.index', ['status' => 'active']) }}" class="rounded-lg shadow p-4 border hover:shadow-lg transition-shadow cursor-pointer" style="background-color: var(--card-bg-color, #ffffff); border-color: var(--border-color, #e5e7eb);">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xl font-bold" style="color: var(--text-primary-color, #111827);">{{ $activeLicenses }}</p>
                </div>
            </div>
        </a>
        
        <a href="{{ route('licenses.index', ['status' => 'expired_soon']) }}" class="rounded-lg shadow p-4 border hover:shadow-lg transition-shadow cursor-pointer" style="background-color: var(--card-bg-color, #ffffff); border-color: var(--border-color, #e5e7eb);">
            <div class="flex items-center">
                <div class="p-2 rounded-full" style="background-color: var(--yellow-bg-color, #fef9c3);">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: var(--yellow-text-color, #ca8a04);">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xl font-bold" style="color: var(--yellow-text-color, #ca8a04);">{{ $licensesExpiredSoon }}</p>
                </div>
            </div>
        </a>
        
        <a href="{{ route('licenses.index', ['status' => 'inactive']) }}" class="rounded-lg shadow p-4 hover:shadow-lg transition-shadow cursor-pointer" style="background-color: var(--card-bg-color, #ffffff);">
            <div class="flex items-center">
                <div class="p-2 rounded-full" style="background-color: var(--red-bg-color, #fee2e2);">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: var(--red-text-color, #dc2626);">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xl font-bold" style="color: var(--red-text-color, #dc2626);">{{ $licensesExpired }}</p>
                </div>
            </div>
        </a>

        <a href="{{ route('emails.index') }}" class="rounded-lg shadow p-4 border hover:shadow-lg transition-shadow cursor-pointer" style="background-color: var(--card-bg-color, #ffffff); border-color: var(--border-color, #e5e7eb);">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xl font-bold" style="color: var(--text-primary-color, #111827);">{{ $totalEmails }}</p>
                </div>
            </div>
        </a>
        
        <a href="{{ route('emails.index', ['status' => 'active']) }}" class="rounded-lg shadow p-4 border hover:shadow-lg transition-shadow cursor-pointer" style="background-color: var(--card-bg-color, #ffffff); border-color: var(--border-color, #e5e7eb);">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xl font-bold" style="color: var(--green-text-color, #16a34a);">{{ $activeEmails }}</p>
                </div>
            </div>
        </a>
        
        <a href="{{ route('emails.index', ['status' => 'not used']) }}" class="rounded-lg shadow p-4 border hover:shadow-lg transition-shadow cursor-pointer" style="background-color: var(--card-bg-color, #ffffff); border-color: var(--border-color, #e5e7eb);">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xl font-bold" style="color: var(--gray-text-color, #4b5563);">{{ $notUsedEmails }}</p>
                </div>
            </div>
        </a>
        
        <a href="{{ route('emails.index', ['status' => 'inactive']) }}" class="rounded-lg shadow p-4 hover:shadow-lg transition-shadow cursor-pointer" style="background-color: var(--card-bg-color, #ffffff);">
            <div class="flex items-center">
                <div class="p-2 rounded-full" style="background-color: var(--red-bg-color, #fee2e2);">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: var(--red-text-color, #dc2626);">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xl font-bold" style="color: var(--red-text-color, #dc2626);">{{ $inactiveEmails }}</p>
                </div>
            </div>
        </a>
    </div>
    ...
    <div class="rounded-lg shadow p-6 border" style="background-color: var(--card-bg-color, #ffffff); border-color: var(--border-color, #e5e7eb);">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="{{ route('assets.index') }}" class="text-green-600 hover:text-green-800 dark:text-green-400 dark:hover:text-green-300 text-sm font-medium">View All</a>
        </div>
                    ...
                    @forelse($recentAssets as $asset)
                        <tr style="background-color: var(--card-bg-color, #ffffff);" onmouseover="this.style.backgroundColor='var(--gray-bg-color, #f9fafb)'" onmouseout="this.style.backgroundColor='var(--card-bg-color, #ffffff)'">
                            <td class="px-4 py-3 whitespace-nowrap">
                                <a href="{{ route('assets.show', $asset) }}" class="text-green-600 hover:text-green-900 font-medium">
                                    {{ $asset->asset_code }}
                                </a>
                            </td>
                            ...
                            <td class="px-4 py-3 whitespace-nowrap">
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                    @switch($asset->status)
                                        ...
                                        @case('in_service') bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-200 @break
                                        @case('request_disposal') bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-200 @break
                                        @case('disposal') bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-200 @break
                                    @endswitch">
