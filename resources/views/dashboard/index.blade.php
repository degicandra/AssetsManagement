...
<div class="space-y-6 min-h-screen">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
        <a href="{{ route('assets.index') }}" class="rounded-lg shadow p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow cursor-pointer">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xl font-bold text-gray-700 dark:text-gray-300">{{ $totalAssets }}</p>
                </div>
            </div>
        </a>

        <a href="{{ route('assets.index', ['status' => 'deployed']) }}" class="rounded-lg shadow p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow cursor-pointer">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xl font-bold text-gray-700 dark:text-gray-300">{{ $deployed }}</p>
                </div>
            </div>
        </a>

        <a href="{{ route('assets.index', ['status' => 'ready_to_deploy']) }}" class="rounded-lg shadow p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow cursor-pointer">
            <div class="flex items-center">
                <div class="p-2 rounded-full" style="background-color: var(--blue-bg-color, #dbeafe);">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: var(--blue-text-color, #2563eb);">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xl font-bold text-gray-700 dark:text-gray-300">{{ $readyToDeploy }}</p>
                </div>
            </div>
        </a>

        <a href="{{ route('assets.index', ['status' => 'archive']) }}" class="rounded-lg shadow p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow cursor-pointer">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xl font-bold text-gray-700 dark:text-gray-300">{{ $archive }}</p>
                </div>
            </div>
        </a>

        <a href="{{ route('assets.index', ['status' => 'broken']) }}" class="rounded-lg shadow p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow cursor-pointer">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xl font-bold text-gray-700 dark:text-gray-300">{{ $broken }}</p>
                </div>
            </div>
        </a>

        <a href="{{ route('assets.index', ['status' => 'in_service']) }}" class="rounded-lg shadow p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow cursor-pointer">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xl font-bold text-gray-700 dark:text-gray-300">{{ $inService }}</p>
                </div>
            </div>
        </a>

        <a href="{{ route('assets.index', ['status' => 'request_disposal']) }}" class="rounded-lg shadow p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow cursor-pointer">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xl font-bold text-gray-700 dark:text-gray-300">{{ $requestDisposal }}</p>
                </div>
            </div>
        </a>
        ...
        <a href="{{ route('licenses.index', ['status' => 'active']) }}" class="rounded-lg shadow p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow cursor-pointer">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xl font-bold text-gray-700 dark:text-gray-300">{{ $activeLicenses }}</p>
                </div>
            </div>
        </a>
        
        <a href="{{ route('licenses.index', ['status' => 'expired_soon']) }}" class="rounded-lg shadow p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow cursor-pointer">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xl font-bold text-gray-700 dark:text-gray-300">{{ $licensesExpiredSoon }}</p>
                </div>
            </div>
        </a>
        
        <a href="{{ route('licenses.index', ['status' => 'inactive']) }}" class="rounded-lg shadow p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow cursor-pointer">
            <div class="flex items-center">
                <div class="p-2 rounded-full" style="background-color: var(--red-bg-color, #fee2e2);">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: var(--red-text-color, #dc2626);">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xl font-bold text-gray-700 dark:text-gray-300">{{ $licensesExpired }}</p>
                </div>
            </div>
        </a>

        <a href="{{ route('emails.index') }}" class="rounded-lg shadow p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow cursor-pointer">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xl font-bold text-gray-700 dark:text-gray-300">{{ $totalEmails }}</p>
                </div>
            </div>
        </a>
        
        <a href="{{ route('emails.index', ['status' => 'active']) }}" class="rounded-lg shadow p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow cursor-pointer">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xl font-bold text-gray-700 dark:text-gray-300">{{ $activeEmails }}</p>
                </div>
            </div>
        </a>
        
        <a href="{{ route('emails.index', ['status' => 'not used']) }}" class="rounded-lg shadow p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow cursor-pointer">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xl font-bold text-gray-700 dark:text-gray-300">{{ $notUsedEmails }}</p>
                </div>
            </div>
        </a>
        
        <a href="{{ route('emails.index', ['status' => 'inactive']) }}" class="rounded-lg shadow p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow cursor-pointer">
            <div class="flex items-center">
                <div class="p-2 rounded-full" style="background-color: var(--red-bg-color, #fee2e2);">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: var(--red-text-color, #dc2626);">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xl font-bold text-gray-700 dark:text-gray-300">{{ $inactiveEmails }}</p>
                </div>
            </div>
        </a>
    </div>
