            ...
            <table class="w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700" id="user-table-body">
                    @forelse($users as $user)
                        <tr class="user-row hover:bg-gray-50 dark:hover:bg-gray-700 transition" data-name="{{ strtolower($user->name) }}" data-email="{{ strtolower($user->email) }}">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-600 dark:text-gray-400">{{ $user->created_at->format('M d, Y') }}</div>
                            </td>
