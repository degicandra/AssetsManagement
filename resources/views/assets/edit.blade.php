...
<div class="max-w-4xl mx-auto">
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
        <form action="{{ route('assets.update', $asset) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            @csrf
            @method('PUT')
            <div class="mb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                    <label for="company" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        Company *
                          ...
                          <input type="text" name="company" id="company" value="{{ old('company', $asset->company) }}" required
                ...
                <div>
                    <label for="model" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        Model *
                          ...
                          <input type="text" name="model" id="model" value="{{ old('model', $asset->model) }}" required
                              class="w-full rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 shadow-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500">
                    @error('model')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    <label for="brand" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        Brand *
                          ...
                          <input type="text" name="brand" id="brand" value="{{ old('brand', $asset->brand) }}" required
                              class="w-full rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 shadow-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500">
                    @error('brand')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    <label for="status" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        ...
                        <option value="archive" {{ old('status', $asset->status) == 'archive' ? 'selected' : '' }}>Archive</option>
                        <option value="broken" {{ old('status', $asset->status) == 'broken' ? 'selected' : '' }}>Broken</option>
                        <option value="service" {{ old('status', $asset->status) == 'service' ? 'selected' : '' }}>Service</option>
                        <option value="request_disposal" {{ old('status', $asset->status) == 'request_disposal' ? 'selected' : '' }}>Request Disposal</option>
                    ...
                    <label for="warranty_expiration" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        Warranty Expiration
                          ...
                          <input type="date" name="warranty_expiration" id="warranty_expiration" 
                              value="{{ old('warranty_expiration', $asset->warranty_expiration ? $asset->warranty_expiration->format('Y-m-d') : '') }}"
                              class="w-full rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 shadow-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500">
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="processor" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                           ...
                           <input type="text" name="processor" id="processor" value="{{ old('processor', $asset->processor) }}"
                               class="w-full rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 shadow-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500"
                    ...
                    <div>
                        <label for="storage_size" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                           ...
                           <input type="text" name="storage_size" id="storage_size" value="{{ old('storage_size', $asset->storage_size) }}"
                               class="w-full rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 shadow-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500"
                    ...
                    <div>
                        <label for="ram" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                           ...
                           <input type="text" name="ram" id="ram" value="{{ old('ram', $asset->ram) }}"
                               class="w-full rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 shadow-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500"
